...
% ================================================================================
% Generated on: 10/30/2019 22:30:27
...
mode_mapping = [0,1,2,3,4,5,6,7];
  coef_in_file = fopen ('fir_fir_compiler_ii_0_coef_reload.txt', 'r');
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = fir_fir_compiler_ii_0_mlab(single_channel_data{i}, single_channel_bank{i}, h);
