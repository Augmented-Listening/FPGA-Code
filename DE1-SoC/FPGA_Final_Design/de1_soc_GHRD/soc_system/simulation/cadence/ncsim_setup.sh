...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/ubuntu/intelFPGA/17.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/mic_system_0_mic_master_agent/
mkdir -p ./libraries/mic_system_0_mic_master_translator/
mkdir -p ./libraries/avalon_st_adapter/
mkdir -p ./libraries/mic_system_0_mic_slave_burst_adapter/
mkdir -p ./libraries/hps_0_h2f_lw_axi_master_wr_limiter/
mkdir -p ./libraries/router_002/
mkdir -p ./libraries/mic_system_0_mic_slave_agent_rsp_fifo/
mkdir -p ./libraries/mic_system_0_mic_slave_agent/
mkdir -p ./libraries/hps_0_h2f_lw_axi_master_agent/
mkdir -p ./libraries/mic_system_0_mic_slave_translator/
...
mkdir -p ./libraries/mic_system_0/
mkdir -p ./libraries/hps_0/
mkdir -p ./libraries/Secondary_PLL/
mkdir -p ./libraries/Pushbuttons/
mkdir -p ./libraries/Primary_PLL/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                            -work mic_system_0_mic_master_agent         -cdslib ./cds_libs/mic_system_0_mic_master_agent.cds.lib        
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                       -work mic_system_0_mic_master_translator    -cdslib ./cds_libs/mic_system_0_mic_master_translator.cds.lib   
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter.sv"                                           -work mic_system_0_mic_slave_burst_adapter  -cdslib ./cds_libs/mic_system_0_mic_slave_burst_adapter.cds.lib 
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_uncmpr.sv"                                    -work mic_system_0_mic_slave_burst_adapter  -cdslib ./cds_libs/mic_system_0_mic_slave_burst_adapter.cds.lib 
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_13_1.sv"                                      -work mic_system_0_mic_slave_burst_adapter  -cdslib ./cds_libs/mic_system_0_mic_slave_burst_adapter.cds.lib 
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_new.sv"                                       -work mic_system_0_mic_slave_burst_adapter  -cdslib ./cds_libs/mic_system_0_mic_slave_burst_adapter.cds.lib 
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_incr_burst_converter.sv"                                           -work mic_system_0_mic_slave_burst_adapter  -cdslib ./cds_libs/mic_system_0_mic_slave_burst_adapter.cds.lib 
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_wrap_burst_converter.sv"                                           -work mic_system_0_mic_slave_burst_adapter  -cdslib ./cds_libs/mic_system_0_mic_slave_burst_adapter.cds.lib 
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_default_burst_converter.sv"                                        -work mic_system_0_mic_slave_burst_adapter  -cdslib ./cds_libs/mic_system_0_mic_slave_burst_adapter.cds.lib 
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                       -work mic_system_0_mic_slave_burst_adapter  -cdslib ./cds_libs/mic_system_0_mic_slave_burst_adapter.cds.lib 
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_stage.sv"                                       -work mic_system_0_mic_slave_burst_adapter  -cdslib ./cds_libs/mic_system_0_mic_slave_burst_adapter.cds.lib 
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                         -work mic_system_0_mic_slave_burst_adapter  -cdslib ./cds_libs/mic_system_0_mic_slave_burst_adapter.cds.lib 
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                  -work mic_system_0_mic_slave_agent_rsp_fifo -cdslib ./cds_libs/mic_system_0_mic_slave_agent_rsp_fifo.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                             -work mic_system_0_mic_slave_agent          -cdslib ./cds_libs/mic_system_0_mic_slave_agent.cds.lib         
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                      -work mic_system_0_mic_slave_agent          -cdslib ./cds_libs/mic_system_0_mic_slave_agent.cds.lib         
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                        -work mic_system_0_mic_slave_translator     -cdslib ./cds_libs/mic_system_0_mic_slave_translator.cds.lib    
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_clock_edge.v"                                                   -work mic_system_0                          -cdslib ./cds_libs/mic_system_0.cds.lib                         
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/avalon_microphone_system.sv"                                              -work mic_system_0                          -cdslib ./cds_libs/mic_system_0.cds.lib                         
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/i2s_master.sv"                                                            -work mic_system_0                          -cdslib ./cds_libs/mic_system_0.cds.lib                         
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mic_dma.sv"                                                               -work mic_system_0                          -cdslib ./cds_libs/mic_system_0.cds.lib                         
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_Secondary_PLL.vo"                                              -work Secondary_PLL                         -cdslib ./cds_libs/Secondary_PLL.cds.lib                        
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_Pushbuttons.v"                                                 -work Pushbuttons                           -cdslib ./cds_libs/Pushbuttons.cds.lib                          
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_Primary_PLL.vo"                                                -work Primary_PLL                           -cdslib ./cds_libs/Primary_PLL.cds.lib                          
