...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/avalon_microphone_system.sv \
  $QSYS_SIMDIR/submodules/i2s_master.sv \
  $QSYS_SIMDIR/submodules/mic_dma.sv \
  $QSYS_SIMDIR/submodules/soc_system_hps_0.v \
  $QSYS_SIMDIR/submodules/soc_system_Secondary_PLL.vo \
  $QSYS_SIMDIR/submodules/soc_system_Pushbuttons.v \
  $QSYS_SIMDIR/submodules/soc_system_Primary_PLL.vo \
