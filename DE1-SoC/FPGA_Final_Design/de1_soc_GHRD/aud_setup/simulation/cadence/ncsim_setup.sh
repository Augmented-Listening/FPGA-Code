...
# ACDS 17.1 590 linux 2019.10.30.22:29:12
...
# ----------------------------------------
# If aud_setup is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/aud_setup_audio_and_video_config_0.v"             -work audio_and_video_config_0 -cdslib ./cds_libs/audio_and_video_config_0.cds.lib
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/aud_setup_audio_0.v"                              -work audio_0                  -cdslib ./cds_libs/audio_0.cds.lib                 
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dspba_library_package.vhd"                        -work FIR_LEFT                 -cdslib ./cds_libs/FIR_LEFT.cds.lib                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dspba_library.vhd"                                -work FIR_LEFT                 -cdslib ./cds_libs/FIR_LEFT.cds.lib                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/auk_dspip_math_pkg_hpfir.vhd"                     -work FIR_LEFT                 -cdslib ./cds_libs/FIR_LEFT.cds.lib                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/auk_dspip_lib_pkg_hpfir.vhd"                      -work FIR_LEFT                 -cdslib ./cds_libs/FIR_LEFT.cds.lib                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/auk_dspip_avalon_streaming_controller_hpfir.vhd"  -work FIR_LEFT                 -cdslib ./cds_libs/FIR_LEFT.cds.lib                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/auk_dspip_avalon_streaming_sink_hpfir.vhd"        -work FIR_LEFT                 -cdslib ./cds_libs/FIR_LEFT.cds.lib                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/auk_dspip_avalon_streaming_source_hpfir.vhd"      -work FIR_LEFT                 -cdslib ./cds_libs/FIR_LEFT.cds.lib                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/auk_dspip_roundsat_hpfir.vhd"                     -work FIR_LEFT                 -cdslib ./cds_libs/FIR_LEFT.cds.lib                
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                          -work FIR_LEFT                 -cdslib ./cds_libs/FIR_LEFT.cds.lib                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/aud_setup_FIR_LEFT_rtl_core.vhd"                  -work FIR_LEFT                 -cdslib ./cds_libs/FIR_LEFT.cds.lib                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/aud_setup_FIR_LEFT_ast.vhd"                       -work FIR_LEFT                 -cdslib ./cds_libs/FIR_LEFT.cds.lib                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/aud_setup_FIR_LEFT.vhd"                           -work FIR_LEFT                 -cdslib ./cds_libs/FIR_LEFT.cds.lib                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/aud_setup_FIR_LEFT_tb.vhd"                        -work FIR_LEFT                 -cdslib ./cds_libs/FIR_LEFT.cds.lib                
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/aud_setup.v"                                                                                                                                   
fi
