...
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.aud_setup_FIR_LEFT_tb -section_id tb
...
if {[file exists $file_dir/aud_setup_FIR_LEFT_coef_reload.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/aud_setup_FIR_LEFT_coef_reload.txt -section_id tb -library work
}
if {[file exists $file_dir/aud_setup_FIR_LEFT_coef_reload_rtl.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/aud_setup_FIR_LEFT_coef_reload_rtl.txt -section_id tb -library work
}
set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/aud_setup_FIR_LEFT_input.txt -section_id tb -library work

set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/aud_setup_FIR_LEFT_tb.vhd -section_id tb -library work
