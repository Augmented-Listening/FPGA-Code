...
% ================================================================================
% Generated on: 10/30/2019 22:29:11
...
for j = 1:sx
    ...
    %
    file_name = ['aud_setup_FIR_LEFT_input.txt'];
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = aud_setup_FIR_LEFT_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['aud_setup_FIR_LEFT_model_output'];
