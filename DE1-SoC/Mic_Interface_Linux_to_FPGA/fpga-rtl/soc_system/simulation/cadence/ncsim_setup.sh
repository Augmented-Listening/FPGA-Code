...
mkdir -p ./libraries/Audio_Interface/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_buttons.v"                                                  -work buttons                                                          -cdslib ./cds_libs/buttons.cds.lib                                                         
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/avalon_audio_interface.sv"                                             -work Audio_Interface                                                  -cdslib ./cds_libs/Audio_Interface.cds.lib                                                 
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/i2s_receive.v"                                                         -work Audio_Interface                                                  -cdslib ./cds_libs/Audio_Interface.cds.lib                                                 
