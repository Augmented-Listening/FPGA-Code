...
# ACDS 17.1 590 linux 2019.10.22.18:33:05
# ----------------------------------------
...
ensure_lib                                                                  ./libraries/Audio_Interface                                                 
vmap       Audio_Interface                                                  ./libraries/Audio_Interface                                                 
...
alias com {
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_buttons.v"                                                                               -work buttons                                                         
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/avalon_audio_interface.sv"                                             -l altera_common_sv_packages -work Audio_Interface                                                 
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/i2s_receive.v"                                                                                      -work Audio_Interface                                                 
